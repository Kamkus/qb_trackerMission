...
Config.NPC = {
    ...
    locations = {vec4(959.235168, 3616.259277, 32.750977, 53.858269),
...
Config.tuckerLocations = {{
    ...
    vehPositions = {vec4(1295.986816, 3140.597900, 40.400757, 286.299194),
                    vec4(1236.962646, 3124.786865, 40.400757, 104.881889)}
}, {
    areaPosition = vec3(1365.692261, -579.204407, 74.369995),
    vehPositions = {vec4(1359.969238, -609.375793, 74.336304, 0.000000),
...
---Don't touch
Config.RequestModel = function(model)
    RequestModel(model)
